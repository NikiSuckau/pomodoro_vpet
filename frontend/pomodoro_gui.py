...
class PomodoroGUI:
    ...
    def create_widgets(self) -> None:
        ...
        # Place Skip and Config buttons below the main buttons
        config_frame = tk.Frame(self.parent_frame, bg=self.transparent_color)
        config_frame.pack(pady=(8, 0))
        ...
        # Events button (same size as Exit)
    ...
    def _open_config_window(self) -> None:
        ...
        # Position config window near the parent window
        try:
            # Find root window
            ...
            self.config_window.geometry(f"{config_w}x{config_h}+{x}+{y}")
        except Exception:
            pass
